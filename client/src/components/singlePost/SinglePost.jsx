...
export default function SinglePost() {
  return (
    ...
    <img  src="https://source.unsplash.com/900x600/?girls" alt="" className="singlePostImg" />

    <h1 className="singlePostTitle">
        give me a word, i will built a worls out of it.
...
Embrace the allure of the lovely moon, let it inspire you to wander into realms unknown, and bask in the enchantment that only the moon can offer. Let its radiance illuminate your dreams and guide you through the darkest nights, for within its luminous presence lies a world of magic waiting to be discovered.</p>
    </div>
    </div>
  )
}
